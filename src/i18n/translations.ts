...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'Get instant answers to farming questions, disease identification from photos, and connect with agricultural experts - all powered by advanced AI technology.',
    ...
    'hero.card.image.desc': 'Upload crop photos for AI-powered pest & disease identification',
    'hero.card.image.button': 'Upload Photo',
    'hero.card.voice.title': 'Voice Input',
    'hero.card.voice.desc': 'Ask questions using voice for hands-free operation',
    'hero.card.voice.button': 'Voice Query',
    'hero.card.expert.title': 'Expert Connect',
    'hero.card.expert.desc': 'Connect with agricultural experts for complex issues',
    'hero.card.expert.button': 'Find Expert',

    // Chat
    'chat.header': 'AI Farm Assistant',
    'chat.placeholder': 'Ask about crops, pests, soil, weather...',
    'chat.greeting': "Hello! I'm your AI farming assistant. I can help you with crop management, pest control, soil health, and more. What would you like to know?",
    ...
    'image.upload.desc': 'Drop an image here or click to select from your device',
    ...
    'expert.toast.notAvailable.desc': 'This expert is currently not available. Please try another expert.',
    ...
    'expert.howItWorks.desc': 'The expert will review your request and contact you via phone or video call within 24 hours.',
  ...
  ml: {
    ...
    'hero.subtitle': 'കൃഷിയുമായി ബന്ധപ്പെട്ട ചോദ്യങ്ങൾക്ക് ഉടൻ മറുപടി, ഫോട്ടോകളിൽ നിന്ന് രോഗനിർണ്ണയം, കൂടാതെ കാർഷിക വിദഗ്ധരുമായി ബന്ധപ്പെടുക — എല്ലാം ആധുനിക എ.ഐ. ഉപയോഗിച്ച്.',
    ...
    'hero.card.image.desc': 'എ.ഐ. ഉപയോഗിച്ച് കീട-രോഗങ്ങൾ തിരിച്ചറിയാൻ വിളകളുടെ ഫോട്ടോകൾ അപ്ലോഡ് ചെയ്യുക',
    ...
    'hero.card.expert.desc': 'സങ്കീർണ്ണ വിഷയങ്ങൾക്ക് കാർഷിക വിദഗ്ധരുമായി ബന്ധപ്പെടുക',
    'hero.card.expert.button': 'വിദഗ്ധനെ കണ്ടെത്തുക',

    // Chat
    'chat.header': 'എ.ഐ. കൃഷി സഹായി',
    'chat.placeholder': 'വിളകൾ, കീടങ്ങൾ, മണ്ണ്, കാലാവസ്ഥ എന്നിവയെക്കുറിച്ച് ചോദിക്കുക...',
    'chat.greeting': 'ഹലോ! ഞാൻ നിങ്ങളുടെ എ.ഐ. കൃഷി സഹായി. വിള പരിപാലനം, കീടനിയന്ത്രണം, മണ്ണ് ആരോഗ്യo മുതലായവയിൽ സഹായിക്കാം. എന്ത് അറിയണം?',
    ...
    'chat.voice.error.desc': 'ദയവായി വീണ്ടും ശ്രമിക്കുകയോ ടൈപ്പ് ചെയ്യുകയോ ചെയ്യൂ',
    ...
    'image.upload.desc': 'ഇവിടെ ചിത്രം ഇടുക അല്ലെങ്കിൽ ഉപകരണത്തിൽ നിന്ന് തിരഞ്ഞെടുക്കുക',
    ...
    'expert.choose.desc': 'നിങ്ങളുടെ കൃഷി ആവശ്യങ്ങൾക്ക് അനുയോജ്യനായ വിദഗ്ധനെ തിരഞ്ഞെടുക്കുക',
    ...
    'expert.toast.notAvailable.desc': 'ഈ വിദഗ്ധൻ ഇപ്പോൾ ലഭ്യമല്ല. ദയവായി മറ്റൊരാളെ ശ്രമിക്കുക.',
    'expert.toast.missing.title': 'വിവരങ്ങൾ ലഭ്യമല്ല',
    'expert.toast.missing.desc': 'ദയവായി ആവശ്യമായ എല്ലാ ഫീൽഡുകളും പൂരിപ്പിക്കുക',
    ...
    'expert.howItWorks.desc': 'വിദഗ്ധൻ നിങ്ങളുടെ അഭ്യർത്ഥന പരിശോധിച്ച് 24 മണിക്കൂറിനുള്ളിൽ ഫോൺ അല്ലെങ്കിൽ വീഡിയോ കോളിലൂടെ ബന്ധപ്പെടും.',
